...
if(data.exposeOptionsRoutes === undefined){
data.exposeOptionsRoutes = false;
}
...
if(valid0){
let data22 = data.exposeOptionsRoutes;
...
validate10.errors = [{instancePath:instancePath+"/exposeOptionsRoutes",schemaPath:"#/properties/exposeOptionsRoutes/type",keyword:"type",params:{type: "boolean"},message:"must be boolean"}];
return false;
}
}
if(coerced25 !== undefined){
data22 = coerced25;
if(data !== undefined){
data["exposeOptionsRoutes"] = coerced25;
}
}
}
